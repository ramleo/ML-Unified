"""Open Images V7's 601 class names, split out of mm_objects.py purely to
keep that file under the project's line-length cap — this is a pure data
constant with no logic, so it has no docstring/behavior of its own beyond
what mm_objects.py's module docstring already explains about the model."""

# In the exact index order the model was trained/exported with (ultralytics
# YOLO(...).names, 0-indexed).
OIV7_CLASSES = [
